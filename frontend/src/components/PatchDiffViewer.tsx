...
import { Wrench, CheckCircle2, XCircle, FileDiff } from "lucide-react";
...
const defaultDiff = `--- a/app/services/payment.py
...
export function PatchDiffViewer({
  patchDiff = defaultDiff,
  explanation = "Corrected boundary condition logic to enforce exception handling for zero payment amounts.",
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-[#6B7280]">Automated Program Repair (APR) Candidate Patch</p>
          </div>
        </div>
